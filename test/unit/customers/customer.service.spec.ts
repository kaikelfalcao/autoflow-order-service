...
describe("CustomerService", () => {
  ...
  beforeEach(() => {
    ...
    service = new CustomerService(repo, logger as any);
  });
  ...
  describe("deactivate", () => {
    ...
    it("throws CustomerHasActiveVehiclesError when vehicles exist", async () => {
      ...
      await expect(service.deactivate("customer-1")).rejects.toThrow(
        CustomerHasActiveVehiclesError,
      );
    });
